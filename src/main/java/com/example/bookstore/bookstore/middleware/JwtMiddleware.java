package com.example.bookstore.bookstore.middleware;
...
public class JwtMiddleware extends OncePerRequestFilter {
    ...
    public JwtMiddleware(JwtService jwtService, UserDetailsServiceImpl userDetailsService) {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if (email != null && SecurityContextHolder.getContext().getAuthentication() == null) {
            ...
            if (jwtService.isTokenValid(jwt, userDetails)) {
                ...
                // ✅ Simpan authentication ke context
